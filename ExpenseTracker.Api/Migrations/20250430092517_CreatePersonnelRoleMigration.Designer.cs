...
namespace ExpenseTracker.Api.Migrations
{
    ...
    [Migration("20250430092517_CreatePersonnelRoleMigration")]
    partial class CreatePersonnelRoleMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExpenseTracker.Domain.PersonnelPassword", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ExpenseTracker.Domain.PersonnelRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ExpenseTracker.Domain.Personnel", b =>
                {
                    b.HasOne("ExpenseTracker.Domain.PersonnelRole", "Role")
                        .WithMany("Personnels")
            ...
            modelBuilder.Entity("ExpenseTracker.Domain.PersonnelPassword", b =>
                {
                    b.HasOne("ExpenseTracker.Domain.Personnel", "Personnel")
                        ...
                        .HasForeignKey("ExpenseTracker.Domain.PersonnelPassword", "PersonnelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
