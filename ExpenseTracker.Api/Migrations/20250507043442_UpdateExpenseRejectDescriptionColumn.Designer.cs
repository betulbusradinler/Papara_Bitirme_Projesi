...
namespace ExpenseTracker.Api.Migrations
{
    ...
    [Migration("20250507043442_UpdateExpenseRejectDescriptionColumn")]
    partial class UpdateExpenseRejectDescriptionColumn
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ExpenseTracker.Api.Domain.Expense", b =>
                {
                    ...
                    b.Property<string>("RejectDescription")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(max)")
                        .HasDefaultValue("Reddedilme Mesajı Yok.");
            ...
            modelBuilder.Entity("ExpenseTracker.Api.Domain.Personnel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            CreatedDate = new DateTime(2025, 5, 7, 7, 34, 41, 800, DateTimeKind.Local).AddTicks(5260),
                            CreatedUser = "System",
                            ...
                            IsActive = true,
                            LastName = "User",
                            OpenDate = new DateTime(2025, 5, 7, 7, 34, 41, 800, DateTimeKind.Local).AddTicks(5230),
                            Role = "Admin",
                            UserName = "admin"
                        },
                        new
                        {
                            Id = -2,
                            CreatedDate = new DateTime(2025, 5, 7, 7, 34, 41, 800, DateTimeKind.Local).AddTicks(5270),
                            CreatedUser = "System",
                            ...
                            IsActive = true,
                            LastName = "Doe",
                            OpenDate = new DateTime(2025, 5, 7, 7, 34, 41, 800, DateTimeKind.Local).AddTicks(5270),
                            Role = "Personnel",
                            UserName = "personel"
                        });
                });
            ...
            modelBuilder.Entity("ExpenseTracker.Api.Domain.PersonnelPassword", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            CreatedDate = new DateTime(2025, 5, 7, 4, 34, 41, 800, DateTimeKind.Utc).AddTicks(5320),
                            CreatedUser = "system",
                            IsActive = true,
                        ...
                        {
                            Id = -2,
                            CreatedDate = new DateTime(2025, 5, 7, 4, 34, 41, 800, DateTimeKind.Utc).AddTicks(5330),
                            CreatedUser = "system",
                            IsActive = true,
                            Password = "lzrYokbJ5sItqIb9t1mk5VRKmC6SYJtrKDzpwFjvXs2pbA+fwHqydW8/IDnIAQMnM5k5GFgCmVhxJ4CJ8vF08Q==",
                            PersonnelId = -2,
